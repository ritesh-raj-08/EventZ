...
export default function SearchLocationBar() {
  ...
  useEffect(() => {
    if (searchQuery.trim().length < 2 || !convex) {
      setSearchResults([]);
    ...
    const searchTimeoutId = setTimeout(async () => {
      ...
      try {
        // Fetch search results directly from Convex
        const results = await convex.query(api.search.searchEvents, {
          query: searchQuery,
          limit: 5,
        });
                        ...
                        <div className="flex items-center gap-3 text-xs text-muted-foreground">
                          <span className="flex items-center gap-1">
                            ...
                            {(() => {
                              ...
                              return isValid(d) ? format(d, "MMM dd") : "TBD";
                            })()}
                          </span>
                          <span className="flex items-center gap-1">
